<?php
	...
	SF::PRINTER( SF::Get_Random_String( "20" ) );
	...
	echo '<hr>SF::PRINTER( SF::Get_Random_String_Readable( "14" ) ); - Получить случайную удобночитаемую строку';
	SF::PRINTER( SF::Get_Random_String_Readable( 14 ) , "V");
